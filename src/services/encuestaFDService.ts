import { AsignaturasEncuestaFDResponseType, InscritoAnteriorEncuestaFDType, InscritosEncuestaFDResponseType, InscribirEstudianteEncuestaFDType } from "@/types/index.ts";
