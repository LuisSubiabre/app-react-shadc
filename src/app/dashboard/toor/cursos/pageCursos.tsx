...
import { saveNew, savaEdit, deleteRole } from "./cursoService";
...
const Cursos: React.FC = () => {
  ...
  const handleSaveNew = async () => {
    ...
    try {
      await saveNew(newCurso, token); // Usamos la función del servicio roleService.ts
