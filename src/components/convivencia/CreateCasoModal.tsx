...
import { EstudianteType, FaltaType } from "@/types";
import { createCaso, getFaltas } from "@/services/convivenciaService";
import { format } from "date-fns";
import { Plus, Link, FileText, Save, X, AlertTriangle } from "lucide-react";
...
export function CreateCasoModal({
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.falta_id) {
      toast({
        title: "Error",
        description: "Debes seleccionar un tipo de falta.",
        variant: "destructive",
      });
      return;
    }
